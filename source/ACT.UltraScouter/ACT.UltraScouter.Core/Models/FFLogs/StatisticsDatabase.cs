...
namespace ACT.UltraScouter.Models.FFLogs
{
    public class StatisticsDatabase
    {
        ...
        {
            // for KR region
            const string TimestampFileUri = @"https://drive.google.com/uc?id=1s1WeTqw161X_cuzC7GpWG_FsC6ooyqb_&export=download";
            const string DatabaseFileUri = @"https://drive.google.com/uc?id=1pLuFn0iVWfbncYQw2dReIYMHV_ZMknDs&export=download";
